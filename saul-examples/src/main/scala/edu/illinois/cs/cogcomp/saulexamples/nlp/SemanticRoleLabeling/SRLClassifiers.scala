...
object SRLClassifiers {
  ...
  object predicateClassifier extends Learnable(predicates, parameters) {
  ...
  object predicateSenseClassifier extends Learnable(predicates, parameters) {
    def label = predicateSenseGold
    override lazy val classifier = new SparseNetworkLearner()
  }

  object argumentTypeLearner extends Learnable(relations, parameters) {
  ...
  object argumentXuIdentifierGivenApredicate extends Learnable(relations, parameters) {
